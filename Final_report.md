...
Tập dữ liệu huấn luyện giọng nam Việt được khai thác từ bộ dữ liệu công cộng `VieNeu-TTS-140h` (giấy phép Apache 2.0). Đồ án chọn lọc các tệp âm thanh đơn người nói của ba Speaker giọng nam miền Nam tiêu biểu gồm:
*   `jellyfish1010_0004`: 939 clips phát biểu gốc, tổng thời lượng 1.76 giờ.
*   `jellyfish1010_0013`: 594 clips phát biểu gốc, tổng thời lượng 1.27 giờ.
*   `jellyfish1010_0032`: 656 clips phát biểu gốc, tổng thời lượng 1.14 giờ.

Tổng số lượng clips ban đầu đưa vào tiền xử lý là 1999 clips. Biểu đồ phân bố thời lượng phát biểu của các clips được thể hiện trong Hình 4.1:

![Hình 4.1. Biểu đồ phân bố thời lượng của tập dữ liệu giọng nam VieNeu ban đầu](file:///c:/Users/DELL/Downloads/DATN/Report/GradProject_for_report/piper_vi_vais1000_finetuning/reports/dataset_analysis/vieneu_0004_0013_0032_duration_hist.png)

Phân tích biểu đồ chỉ ra thời lượng các clips dao động chủ yếu trong vùng từ 1.5 giây đến 8.0 giây (trung bình 3.65 giây). Đây là dải thời lượng lý tưởng để mô hình TTS học cách phân đoạn âm phổ và ngắt nghỉ tự nhiên, đồng thời giúp tránh lỗi tràn bộ nhớ VRAM trong quá trình huấn luyện.
...
Biểu đồ phân bố tần suất chỉ số Word Error Rate (WER) đối xứng giữa văn bản gốc và văn bản nhận dạng được trình bày trong Hình 4.2:

![Hình 4.2. Biểu đồ phân bố tần suất chỉ số WER của PhoWhisper-large trên 1999 clips VieNeu](file:///c:/Users/DELL/Downloads/DATN/Report/GradProject_for_report/piper_vi_vais1000_finetuning/reports/dataset_analysis/vieneu_qc_stt_wer_hist.png)
...
Quá trình kiểm thử thực tế ứng dụng máy khách PySide6 kết nối đến Server FastAPI mang lại các kết quả ghi nhận như sau:
1.  **Độ ổn định kết nối WebSocket:** Kênh truyền dẫn song công WebSocket duy trì kết nối ổn định xuyên suốt thời gian thử nghiệm dài 2 giờ liên tục. Hệ thống hiển thị mượt mà văn bản tạm thời (interim results) với độ trễ phản hồi trực quan dưới 150ms và cập nhật chính xác văn bản chính thức (final results).
2.  **Hiệu năng AdaptiveJitterPlayer:** Bộ đệm chống giật thích ứng hoạt động hiệu quả. Khi hệ thống mô phỏng độ trễ mạng biến động (jitter) từ 50ms đến 150ms, trình phát tự động điều chỉnh kích thước hàng đệm âm thanh (Jitter Queue), duy trì luồng phát PCM liên tục, loại bỏ hoàn toàn hiện tượng méo tiếng hay giật tiếng chặng cuối.
3.  **Tính cô lập âm thanh chống vọng tiếng (Echo Mitigation):** Thực nghiệm họp trực tuyến thực tế trên Zoom và Google Meet xác nhận giải pháp cách ly WASAPI loopback và định tuyến RoutePlayer hoạt động hoàn hảo:
    *   Âm thanh dịch tiếng Anh (Route 0) được định tuyến trực tiếp vào driver ảo VB-Cable, Zoom nhận dạng chính xác làm thiết bị Micro đầu vào với tín hiệu số sạch sẽ, không có tạp âm phòng họp.
    *   Âm thanh dịch tiếng Việt (Route 1) phát ra tai nghe vật lý của người dùng nội bộ để nghe trực tiếp. WASAPI loopback chỉ ghi âm kênh loa mặc định (nơi chỉ phát tiếng đối tác và tiếng dịch tiếng Việt Route 1 dành cho người dùng nghe bằng tai nghe vật lý), hoàn toàn không thu lại tiếng dịch Route 1, loại bỏ triệt để 100% khả năng xảy ra vòng lặp phản hồi dịch thuật (feedback loop).
...
Mô hình tinh chỉnh giọng nam được thực hiện hồi phục huấn luyện qua 3000 epochs tiếp nối từ checkpoint gốc `vais1000-medium` (tổng cộng 84 checkpoints được lưu lại mỗi 10 epochs). Đường cong hội tụ các chỉ số Mel Reconstruction Loss và KL Divergence Loss trên tập validation được mô tả trong Hình 4.3:

![Hình 4.3. Đường cong hội tụ Mel Loss và KL Loss của quá trình huấn luyện Piper TTS](file:///c:/Users/DELL/Downloads/DATN/Report/GradProject_for_report/piper_vi_vais1000_finetuning/reports/training_curves/loss_zoomed.png)
...
Hình 4.4 trình bày đồ thị mel-spectrogram so sánh phổ âm của cùng một câu phát âm mẫu `"Pin laptop của tôi còn bốn mươi phần trăm..."` (câu 07) giữa mô hình baseline (giọng nữ gốc) và mô hình tinh chỉnh giọng nam:

![Hình 4.4. So sánh phổ âm Mel-Spectrogram giữa mô hình baseline (giọng nữ gốc) và mô hình tinh chỉnh giọng nam](file:///c:/Users/DELL/Downloads/DATN/Report/GradProject_for_report/piper_vi_vais1000_finetuning/reports/plots/spectrograms/sentence_07.png)
...
Hình 4.5 trình bày biểu đồ hộp (Boxplot) đối sánh điểm số chất lượng giọng nói tự nhiên khách quan NISQA MOS và chỉ số WER hồi chuyển chặng STT trên 25 câu test chuẩn giữa 3 mô hình:

![Hình 4.5. Biểu đồ hộp đối sánh điểm NISQA MOS và WER của 3 mô hình](file:///c:/Users/DELL/Downloads/DATN/Report/GradProject_for_report/piper_vi_vais1000_finetuning/reports/plots/nisqa_mos_boxplot.png)

*Bên cạnh đó, biểu đồ phân bố chỉ số WER của các câu test được thể hiện trong hình vẽ boxplot WER:*

![Hình 4.6. Biểu đồ hộp đối sánh chỉ số Word Error Rate (WER) hồi chặng của 3 mô hình](file:///c:/Users/DELL/Downloads/DATN/Report/GradProject_for_report/piper_vi_vais1000_finetuning/reports/plots/wer_boxplot.png)
...
Sơ đồ mạng nhện Radar (`final_radar.png`) tổng hợp 5 tiêu chí xếp hạng được đính kèm ở Hình 4.7:

![Hình 4.7. Sơ đồ mạng nhện Radar tổng hợp xếp hạng 5 tiêu chí của 3 mô hình](file:///c:/Users/DELL/Downloads/DATN/Report/GradProject_for_report/piper_vi_vais1000_finetuning/reports/plots/final_radar.png)
