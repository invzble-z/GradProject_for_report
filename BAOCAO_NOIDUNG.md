...
Đồ án khảo sát nhiều nguồn dữ liệu tiếng nói tiếng Việt. Phương án ban đầu (FPT-FOSD) không phù hợp vì là kho dữ liệu phục vụ nhận dạng (ASR, đa người nói) chứ không phải TTS đơn giọng. Đồ án chuyển sang bộ **VieNeu-TTS-140h** (giấy phép mở, audio chất lượng studio, có nhãn giới tính và người nói). Do thời lượng mỗi người nói nam đơn lẻ nhỏ hơn ngưỡng khuyến nghị (2–3 giờ cho fine-tuning Piper VITS medium), đồ án **ghép ba speaker nam** đồng nhất chất giọng (`jellyfish1010_0004`, `_0013`, `_0032`) để đạt thời lượng đủ. ✅
...
Hai chiến lược huấn luyện ở Giai đoạn 2 dùng hai bộ chuẩn hóa văn bản khác nhau: **vinorm** (cho Run A) và **vietnormalizer + danh sách bảo vệ (protect-list)** (cho Run B1). vietnormalizer xử lý tốt hơn các từ tiếng Anh/tên riêng (phiên âm) và làm sạch dấu câu phù hợp với espeak-ng; protect-list ngăn một số từ tiếng Việt không dấu bị phiên âm sai. ✅
...
- **Độ rõ chữ (Intelligibility):** WER/CER theo phương pháp hồi chuyển — nhận dạng ngược âm thanh tổng hợp rồi so với văn bản gốc — dùng **hai hệ ASR độc lập** (PhoWhisper-large và Whisper-large-v3) để tăng độ tin cậy của thứ hạng.
- **Độ tự nhiên (Naturalness):** điểm **NISQA-TTS MOS** (thang 1–5); kèm khảo sát chủ quan (Human MOS) để đối chiếu.
